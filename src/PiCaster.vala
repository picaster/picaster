class PiCaster : Gtk.Application
{
    ...
    protected override void activate()
    {
        ...
        main_window.add_accel_group(PiCaster.accel_group);
        /*
        ...
        */
        ...
        notebook.append_page(new MainPage(), new Gtk.Label("Main"));
